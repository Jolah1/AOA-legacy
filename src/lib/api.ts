...
const FALLBACK_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    summary:
      "Upscale commercial office development featuring high-end finishes, smart office technology, and sustainable design.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Bespoke walk-in dressing room featuring mirrored wardrobes, custom island unit, and full-marble flooring.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Minimalist gallery-style foyer with full-height mirrored joinery, marble floors, and floor-to-ceiling glazing.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Spa-grade master bathroom in honed white marble with a freestanding tub framed by skyline views.",
    highlights: [
